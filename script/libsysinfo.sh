...
get_nr_core() {
	cat /proc/stat | grep -c "cpu[0-9]"
}

# $1:cpuid
get_maxfreq() {
	cat "/sys/devices/system/cpu/cpu$1/cpufreq/cpuinfo_max_freq"
}
...
is_mtk() {
	soc_model="$(getprop ro.soc.model)"
	hw_check="$(getprop ro.hardware)
                    $(getprop ro.board.platform)
                    $(getprop ro.boot.hardware)
                    $(getprop ro.soc.manufacturer)
                    $soc_model"

	pattern='(mt[0-9]{4}|mediatek|dimensity|helio[ _-]g?[0-9]{2})'
...
get_config_name() {
	case "$1" in
	"rk30sdk") _get_rk30sdk ;;
	"pineapple") _get_pinekala_type ;;
	"kalama") _get_kalama_type ;;
	"taro") _get_taro_type ;;
	"lahaina") _get_lahaina_type ;;
	"shima") _get_lahaina_type ;;
	"yupik") _get_lahaina_type ;;
	"sun") _get_sun_type ;;
	"canoe") echo "sdm8eg5" ;;
	"volcano") echo "sdm7sg3" ;;
	"kona") echo "sdm865" ;;    # 865, 870
	"msmnile") echo "sdm855" ;; # 855, 860
	"sdm845") echo "sdm845" ;;
	"lito") _get_sdm76x_type ;;
	"sm6150") _get_sm6150_type ;;
	"holi") echo "sdm695" ;;
	"sdm710") echo "sdm710" ;;
	"atoll") echo "sdm720" ;;
	"curtana") echo "sdm720" ;;
	...
	"parrot") echo "sdm4g2" ;;
	"msm8937") echo "sdm439" ;;
	"msm8953") echo "sdm625" ;;    # sdm625
	"msm8953pro") echo "sdm625" ;; # sdm626
	"msm8952Pro") echo "sdm653" ;; # sdm653
	"msm8952") echo "sdm653" ;;    # sdm652
	"msm8976SG") echo "sdm653" ;;  # sdm653
	"sdm660") echo "sdm660" ;;
	"sdm636") echo "sdm660" ;;
	...
	"universal7884") echo "e7884" ;;
	"universal7884B") echo "e7884" ;;
	"mt6580") echo "mt6580" ;;
	"mt6765") echo "mtp35" ;; # Helio P35(mt6765)/G35(mt6765g)/G37(mt6765h) etc
	"mt6768") echo "mtg80" ;; # Helio P65(mt6768)/G70(mt6769v)/G80(mt6769t)/G85(mt6769z) etc
	"mt6750") echo "mtp10" ;;
	"OPPO R9m") echo "mtp10" ;;
	"mt6757") echo "mtp20" ;;
